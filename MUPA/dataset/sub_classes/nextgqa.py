...
class NExTGQADataset(AnsweringDataset):
    ...
    @classmethod
    def load_annos(self, split='valid',use_qa=False):
        ...
        if split == 'valid':
            ...
            raw_spans = nncore.load(self.SPAN_PATH_TEST)  # gsub_valid/test.json denotes duration and location
